...
Dice, coins, and card draws for a tabletop game, with a visible roll history.
...
Deriving state from events without persisting anything, and keeping a bounded history in memory.
...
```sh
tp pack cookbook/apps/dice-table
