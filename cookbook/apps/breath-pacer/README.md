...
A four-count breathing pacer driven by a host timer and a progress widget.
...
Time-driven re-render, the `progress` widget, and the cost of a render loop against the broker rate limit.
...
```sh
tp pack cookbook/apps/breath-pacer
