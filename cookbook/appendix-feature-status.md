...
| `ai.chat` | Non-streaming, one in-flight request per app, ≤ 64 messages, `maxTokens` clamped to 8,192, model allowlisted host-side and variable per host. | [7](07-apps-that-use-a-model.md), [8](08-apps-that-build-apps.md#form-forge) | [LIMITATIONS.md §7](../LIMITATIONS.md) |
