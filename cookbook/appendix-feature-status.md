...
| `announce.subscribe()` | Resolves once with a snapshot of the announces already buffered for the namespace — not a live push stream. Nothing arrives while closed, and later announces are only seen by re-polling. Neighborhood board and Swap shelf read what the host-local service already contains at launch. | [5](05-apps-that-find-each-other.md#how-discovery-works) | [docs/miniapp-sdk.md](../docs/miniapp-sdk.md) |
