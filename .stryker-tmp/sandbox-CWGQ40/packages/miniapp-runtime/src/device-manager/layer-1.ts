...
protected readonly drivers = new Map<string, DeviceDriver>();
  ...
  protected readonly streams = new Map<DeviceStreamHandle, DeviceStreamSession>();
  protected readonly egresses = new Map<DeviceStreamHandle, StreamEgress>();
  protected readonly streamShareOfferIds = new Map<DeviceStreamHandle, string>();
  protected readonly streamAdaptation = new Map<DeviceStreamHandle, { appId: string; peer: string; demand: StreamDemand; deficitStreak: number; surplusStreak: number }>();
  ...
  protected requireLiveSession(appId: string, handle: DeviceSessionHandle): LiveSession {
  ...
  protected async availabilityFor(classId: string): Promise<DeviceAvailability> {
