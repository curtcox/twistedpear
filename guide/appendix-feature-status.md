...
|---|---|---|---|
| Freenet integration | Desktop and headless hosts can use package distribution, an HDLC Reticulum interface, propagation mirroring, and `freenet:contract` only through an external v0.2.112 node. It is off by default; mobile/web are deliberately unsupported; writes are globally published and irreversible. | [11](11-using-freenet.md) | [integration plan](../docs/freenet-integration-plan.md), [app-execution ADR](../docs/adr-freenet-app-execution.md) |
