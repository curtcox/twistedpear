...
|---|---|---|---|
| Freenet integration | Desktop and headless hosts can use package distribution, an HDLC Reticulum interface, propagation mirroring, and `freenet:contract` through an external or user-supervised v0.2.112 node. Mobile hosts expose simulator-verified remote-node grant chrome (off by default). Web is unsupported under Option A. Writes are globally published and irreversible. | [11](11-using-freenet.md) | [integration plan](../docs/freenet-integration-plan.md), [simulator-first plan](../docs/freenet-simulator-first-work-plan.md), [app-execution ADR](../docs/adr-freenet-app-execution.md) |
