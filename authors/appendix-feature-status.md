...
| DevStudio projects           | JavaScript projects stay single-file bundles. Guida projects are multi-file (`elm.json` + `src/*.elm`); Format and Check use `apps.format` / `apps.diagnostics`, and Preview compiles through `apps.compile`. | [2](02-hello-world-in-devstudio.md)                                      | [docs/guida-ui.md](../docs/guida-ui.md), [LIMITATIONS.md §7](../LIMITATIONS.md) |
