...
export function pathRequestDestinationHash(
...
export function buildPathRequestData(
  ...
  const raw = shouldUseBuildPathRequestData(stepped.actions)
...
export function parsePathRequestData(
  ...
  const stepped = stepParsePathRequestDataWithActions(
    initialParsePathRequestDataState(),
    {
...
export function pathRequestTagKey(
  ...
  const key = shouldUsePathRequestTagKey(stepped.actions)
