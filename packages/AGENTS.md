...
| `host-core` | Runtime-neutral host orchestration | `app-registry`, `bridge-hyper`, `cas-256t`, `lxmf-ts`, `peer-discovery`, `reticulum-interfaces`, `reticulum-ts` | `src/index.ts` | `npm test -- packages/host-core/test` | changing how a host wires the stack together |
