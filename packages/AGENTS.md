...
| `cli`                      | Command-line host and tooling                                                 | `app-registry`, `bridge-freenet`, `bridge-hyper`, `host-core`, `miniapp-runtime`, `reticulum-ts`, `cas-256t`, `guida-twistedpear`              | `src/index.ts`  | `npm test -- packages/cli/test`                      | changing CLI commands                                             |
