...
export interface AbuseDefinition {
  ...
  readonly mappings: readonly {
    readonly taxonomy: ThreatTaxonomy;
...
export const CAPABILITIES = CAPABILITY_DEFINITIONS.map(
...
export const ABUSE_VERBS: readonly AbuseDefinition[] = [
  {
    ...
    mappings: [
      ...
      { taxonomy: "LINDDUN", category: "Disclosure of Information" },
    ],
  },
  {
    verb: "spoof",
    mappings: [
      ...
      { taxonomy: "LINDDUN", category: "Non-repudiation" },
    ],
  },
  {
    verb: "deny",
    mappings: [
      ...
      { taxonomy: "LINDDUN", category: "Unawareness" },
    ],
  },
  {
    verb: "drain",
    mappings: [{ taxonomy: "STRIDE", category: "Denial of Service" }],
  },
  {
    verb: "correlate",
    mappings: [
      { taxonomy: "LINDDUN", category: "Linkability" },
      { taxonomy: "LINDDUN", category: "Detectability" },
    ],
  },
];
...
export function coverageFrame(
  ...
  const verbs =
    options.verbs === undefined
      ? ABUSE_VERBS
      : ABUSE_VERBS.filter((definition) =>
          options.verbs!.includes(definition.verb),
        );
