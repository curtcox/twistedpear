...
import {
  ...
  supportsQrDetection,
} from "../../apps/host-desktop/src/renderer/qr-scanner.js";
...
describe("desktop QR scanner", () => {
  it("accepts only a 94-character base64url 256t value", () => {
    ...
    expect(() =>
      normalizeScannedT256("https://example.test/not-an-id"),
    ).toThrow("94-character");
    expect(() => normalizeScannedT256(`${"a".repeat(93)}!`)).toThrow(
      "94-character",
    );
  });
