...
export const CALL_SCRIPT = [
...

  {
    ...
    payload: { key: "greeting", value: text("hello") },
  },
  {
    app: "app-a",
    namespace: "storage.kv",
  ...
  },
  {
    ...
    method: "put",
    capability: "storage:hyperbee",
    payload: { key: "post:1", value: text("first") },
  },
  {
    app: "app-a",
    namespace: "storage.bee",
...

  {
    ...
    payload: { to: "app-b", subject: "hi", body: "hello b" },
  },
  {
    app: "app-b",
    namespace: "lxmf",
    method: "send",
    capability: "lxmf:send",
    payload: { to: "app-b", subject: "self", body: "note to self" },
  },
  {
    app: "app-b",
    namespace: "lxmf",
    ...
    note: "delivery to self and from app-a",
  },
  {
    app: "app-b",
    namespace: "lxmf",
  ...
  },
  {
    ...
    method: "receive",
    capability: "lxmf:receive",
    note: "nothing addressed to app-a",
  },

  {
    ...
    payload: { appData: text("post-1"), namespace: "board" },
  },
  {
    app: "app-b",
    namespace: "announce",
  ...
  },
  {
    ...
    method: "fetch",
    capability: "resource:fetch",
    payload: { resourceId: "offer:demo", budgetBytes: 4 },
  ...
  },
  {
    ...
    method: "fetch",
    capability: "resource:fetch",
    payload: { resourceId: "offer:missing" },
  ...
  const walk = (value, key = "") => {
    ...
    if (value !== null && typeof value === "object") {
      ...
      for (const child of Object.keys(value).sort())
        out[child] = walk(value[child], child);
      return out;
    }
    return value;
  };
