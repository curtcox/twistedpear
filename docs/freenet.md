...
**The single most consequential fact:** the Freenet client API exposes _replicated state_,
not _channels_. Every transport role below is therefore a matter of encoding movement of
...
reading of the [plan](freenet-plan.md) §11 for CI _jobs_ — the suites themselves must still skip cleanly without
