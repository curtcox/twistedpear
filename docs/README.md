...
| Mini-app record and replay        | [miniapp-record-replay.md](miniapp-record-replay.md)                                                                   | [miniapp-record-replay-plan.md](miniapp-record-replay-plan.md)                                                                |
...
| Check implemented and verified work                                             | [Completed-work evidence](../STATUS-COMPLETE.md) (index); [v1 pipeline table](../STATUS-COMPLETE-PIPELINE.md); [apps/Guida table](../STATUS-COMPLETE-APPS.md); [early phases](complete-phases-early.md); [phase 2+ tables](../STATUS-COMPLETE-PHASES.md) |
...
[mini-app record and replay](miniapp-record-replay.md)
...
| User-authored, irreversible restrictions on this install   | [User policy](user-policy.md), [remaining plan](user-policy-plan.md), [SPEC-POLICY](../specs/spec-policy/spec.md)               |
