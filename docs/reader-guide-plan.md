...
**Screenshots (RG6).** All three guides ship placeholder graphics — 25 pending files
(`npm run site:section-images:report`; 16 for the guide, 6 for the authors guide, 3 for
