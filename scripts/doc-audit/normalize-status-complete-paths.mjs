...
const replacements = [
  [
    ...
    "`packages/reticulum-ts/test/golden-vectors.test.ts`",
  ],
  [
    "`negative-path.test.ts`",
    "`packages/reticulum-ts/test/negative-path.test.ts`",
  ],
  [
    "`capture-diff.test.ts`",
    "`packages/reticulum-ts/test/capture-diff.test.ts`",
  ],
  ...
  [
    "`transport-node.test.ts`",
    "`packages/reticulum-ts/test/transport-node.test.ts`",
  ],
  ...
  ["`services/*`", "`packages/miniapp-runtime/src/services/`"],
  ...
  [
    "`ble-interop.test.ts`",
    "`packages/reticulum-interfaces/test/ble-interop.test.ts`",
  ],
  [
    "`propagation-server.test.ts`",
    "`packages/lxmf-ts/test/propagation-server.test.ts`",
  ],
  [
  ...
  [
    "`propagation-interop/run.mjs`",
    "`conformance/propagation-interop/run.mjs`",
  ],
  ...
  [
    "`build-bundled-catalog.mjs`",
    "`apps/host-desktop/scripts/build-bundled-catalog.mjs`",
  ],
  [
    "`runtime.js`, scroll `scrollOffset`",
    "`apps/handbook/runtime.js`, scroll `scrollOffset`",
  ],
  [
  ...
  ["`lifecycle-slice.mjs`", "`conformance/ios-sim/lifecycle.mjs`"],
  [
