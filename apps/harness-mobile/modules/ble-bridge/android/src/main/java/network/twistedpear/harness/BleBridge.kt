...
import network.twistedpear.harness.BleBridgeSpec.CLIENT_CONFIG_DESCRIPTOR_UUID
import network.twistedpear.harness.BleBridgeSpec.CONTROL_CHARACTERISTIC_UUID
import network.twistedpear.harness.BleBridgeSpec.DATA_CHARACTERISTIC_UUID
import network.twistedpear.harness.BleBridgeSpec.DEFAULT_MTU
import network.twistedpear.harness.BleBridgeSpec.IDENTITY_BEACON_SIZE
import network.twistedpear.harness.BleBridgeSpec.MTU_FALLBACK_DELAY_MS
...
class BleBridge(
    ...
    private fun openGattServer(activeAdapter: BluetoothAdapter): Boolean {
        ...
        val service = BleBridgeSpec.buildGattService(identityHash)
