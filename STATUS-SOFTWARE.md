...
| DATA-0-KEYS          | open   | Durable mini-app key enumeration and restart-stable quota accounting                     | —                                                                                                 | `npx vitest run packages/worklet-core/test/runtime-key-value-store.test.ts packages/miniapp-runtime/test/storage-kv.test.ts` |
| DATA-1-ARCHIVE       | open   | Chunked encrypted mini-app data archive and CLI export                                   | —                                                                                                 | `npx vitest run packages/host-core/test/app-data-archive.test.ts packages/cli/test/app-data.test.ts`                         |
| DATA-2-RESTORE       | open   | Atomic mini-app data restore with collision, quota, and address warnings                 | —                                                                                                 | `npx vitest run packages/host-core/test/app-data-restore.test.ts packages/cli/test/app-data.test.ts`                         |
...
| TRACE-1-FORMAT       | open   | Mini-app trace format, vectors, and shape-only round trips                               | —                                                                                                 | `npx vitest run packages/miniapp-runtime/test/trace-format.test.ts`                                                          |
| TRACE-2-RECORD       | open   | Broker trace recording with sandbox clock and entropy shims                              | —                                                                                                 | `npx vitest run packages/miniapp-runtime/test/trace-recording.test.ts`                                                       |
...
| TRACE-4-SEALED       | open   | Redacted payload recording and sealed mini-app traces                                    | —                                                                                                 | `npx vitest run packages/miniapp-runtime/test/trace-security.test.ts`                                                        |
...
| SYNC-1-SPEC          | open   | SPEC-SYNC entry format, merge relation, and local topic store                            | —                                                                                                 | `npm run formal:all`                                                                                                         |
| SYNC-2-LOOPBACK      | open   | Loopback storage:sync replication between two local sandboxes                            | —                                                                                                 | `npx vitest run packages/miniapp-runtime/test/storage-sync-loopback.test.ts`                                                 |
| SYNC-3-LXMF          | open   | Offer-bound storage:sync reconciliation over LXMF                                        | —                                                                                                 | `npx vitest run packages/miniapp-runtime/test/storage-sync-lxmf.test.ts`                                                     |
| SYNC-4-PLANES        | open   | Replicated-state plane selection and bulk airtime reservation                            | —                                                                                                 | `npm run test:local-multipeer`                                                                                               |
| SYNC-5-HOSTILE       | open   | Replicated-state retention and Byzantine peer controls                                   | —                                                                                                 | `npm run test:hostile-apps`                                                                                                  |
| SYNC-6-COOKBOOK      | open   | Migrate shared-state Cookbook apps to storage:sync                                       | —                                                                                                 | `npm run test:cookbook`                                                                                                      |
| AX-1-RENDERERS       | open   | Preserve existing accessibility props across every widget renderer                       | —                                                                                                 | `npm run test:widget-parity`                                                                                                 |
| AX-2-SCHEMA          | open   | Bounded widget accessibility schema and SPEC-WIDGET semantics                            | —                                                                                                 | `npm run test:widget-parity`                                                                                                 |
| AX-3-TREE            | open   | Deterministic headless accessibility-tree golden artifacts                               | —                                                                                                 | `npm run test:widget-parity`                                                                                                 |
| AX-4-VALIDATE        | open   | Version-gated accessible-name validation and corrected doctor findings                   | —                                                                                                 | `npm run test:hostile-apps && npm run test:widget-parity`                                                                    |
| AX-5-RATCHET         | open   | Per-app Cookbook accessibility ratchet                                                   | —                                                                                                 | `npm run test:cookbook`                                                                                                      |
