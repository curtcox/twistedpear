...
| Freenet integration | F1–F3/F5 software landed + F6 Option A ADR; **software pause** pending S5 signing/embedding, live S2/S7 write auth, or BareKit S4. Optional live multi-node Freenet evidence only. | [Integration plan](docs/freenet-integration-plan.md), [Option A ADR](docs/adr-freenet-app-execution.md), [F0 evidence](conformance/freenet-spike/evidence-status.json) |
